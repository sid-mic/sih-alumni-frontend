  ...
  render() {
    ...
    return  (
      ...
      ></img>
      {
        ...
        <div className={moduletype.id === this.state.ClickedButton ? "bg-white md:p-5  md:flex md:flex-wrap md:p-5 p-3 delay-75 duration-500 ease-in-out transform hover:scale-125 items-center" : "transparent md:flex md:flex-wrap md:p-5 p-3 delay-75 duration-500 ease-in-out transform hover:scale-125 items-center"}
        id={moduletype.id} 
        key={moduletype.id}
