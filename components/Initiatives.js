          ...
          <div className="grid grid-cols-1 gap-8 mt-12 md:grid-cols-2 lg:grid-cols-3">
            <div className={styles.boxBorder+" block p-8 transition shadow-xl rounded-xl hover:shadow-pink-500/10 hover:border-pink-500/10"}>
              ...
              <div className={styles.plusImage}>
               <a href="https://ariia.gov.in/" target="_blank">Read More</a>
              </div>
            </div>
            ...
            <div className={styles.boxBorder+" block p-8 transition shadow-xl rounded-xl hover:shadow-pink-500/10 hover:border-pink-500/10"}>
              ...
              <div className={styles.plusImage}>
               <a href="https://sih.gov.in/" target="_blank">Read More</a>
              </div>
            </div>
            ...
            <div className={styles.boxBorder+" block p-8 transition shadow-xl rounded-xl hover:shadow-pink-500/10 hover:border-pink-500/10"}>
              ...
              <div className={styles.plusImage}>
               <a href="https://iic.mic.gov.in/" target="_blank">Read More</a>
              </div>
            </div>
            ...
            <div className={styles.boxBorder+" block p-8 transition shadow-xl rounded-xl hover:shadow-pink-500/10 hover:border-pink-500/10"}>
              ...
              <div className={styles.plusImage}>
               <a href="https://kapila.mic.gov.in/" target="_blank">Read More</a>
              </div>
            ...
            <div className={styles.boxBorder+" block p-8 transition shadow-xl rounded-xl hover:shadow-pink-500/10 hover:border-pink-500/10"}>
              ...
              <div className={styles.plusImage}>
               <a href="https://nisp.mic.gov.in/" target="_blank">Read More</a>
              </div>
